...
filename1 = 'meas_MID01441_FID11864_pulseq_treecho_te456_a'; % let's read the reference first.
...
rawdata=reshape(rawdata,[212,32,49896/28*2]);
...
%% section b
data_path = '/data/pnl/home/ql087/data_bwh/2023_12_19_bwh_pulseq/'
filename1 = 'meas_MID01442_FID11865_pulseq_treecho_te456_b'; % let's read the reference first.
D=dir([data_path filename1]);
[~,I]=sort([D(:).datenum]);
twix_obj = mapVBVD([data_path filename1]);
seq = mr.Sequence();
...
%% ACS data
data_path='/data/pnl/home/ql087/data_bwh/2023_12_19_bwh_pulseq/'
filename1 = 'meas_MID01443_FID11866_pulseq_3_shot'; % let's read the reference first.
D=dir([data_path filename1]);
[~,I]=sort([D(:).datenum]);
twix_obj = mapVBVD([data_path filename1]);
seq = mr.Sequence();
...
I_short=reshape(I_short, [88 88 18 17]);
tmp=zeros(88,88,18,18);
tmp(:,:,:,2:end)=I_short;
tmp=tmp(:,:,:,2:2:end);
I_short=tmp(:,:,:,1:3:end);
clear tmp

save_path='/data/pnl/home/ql087/data_processing/2023_12_19_pulseq_multiecho/';
save([save_path 'phantom_pa_me_te456.mat'], 'I_short', '-v7.3')
