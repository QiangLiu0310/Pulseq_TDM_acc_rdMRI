...
filename3 = 'meas_MID00061_FID14101_pulseq_3_shot'; % reference
...
tmp=zeros(88,88,18,84);
tmp(:,:,:,2:end)=I_short;
tmp=reshape(tmp,[88 88 18 28 3]);
tmp1=[2 4:28];
tmp=tmp(:,:,:,tmp1,:);
I_short=tmp;
clear tmp

save([save_path 'phantom_se_te6.mat'], 'I_short', '-v7.3')
