...
save_path='/data/pnl/home/ql087/data_processing/2023_12_22_pulseq_multiecho/tdm/';
data_path = '/data/pnl/home/ql087/data_bwh/2023_12_22_bwh_pulseq/'
filename1 = 'meas_MID00065_FID14105_pulseq_tdm_te456'; % tdm
filename2 = 'meas_MID00066_FID14106_pulseq_3_shot'; % reference
...
for iTDM=1:3
    ...
    rawdata=reshape(rawdata,[212 32 99792/3]);
    ...
    diff_plus_dum=28; % b0 (dummy) + b0 +bo (PA)+ b1000
    ...
    I_short=reshape(I_short, [88 88 18 83]);
