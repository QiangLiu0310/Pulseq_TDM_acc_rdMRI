...
filename1 = 'meas_MID00044_FID78142_SE3_Sinc8'; % let's read the reference first.
...
% tmp=size(rawdata,3);
% rawdata=reshape(rawdata,[212 20 22 3 9 28 3]);
% rawdata=squeeze(rawdata(:,:,:,1,:,:,:));
% rawdata=reshape(rawdata,[212 20 tmp/3]); clear tmp;
