...
%%
data_path = '/data/pnl/home/ql087/data_bwh/2023_12_22_bwh_pulseq_slr/'
filename1 = 'meas_MID00024_FID14064_pulseq_se_te3_4s'; % let's read the reference first.
D=dir([data_path filename1]);
[~,I]=sort([D(:).datenum]);
twix_obj = mapVBVD([data_path filename1]);
seq = mr.Sequence();
read(seq,'/rfanfs/pnl-zorro/home/ql087/qiang_gSlider_data/lq/Tests/Test_2023/Test_69_Dec_17/recon/signleecho_mb1_18sli_2p5mm_R3_multib_te1_recon.seq')
...
% rawdata=reshape(rawdata,[212 32 22 3 18 5]);
% rawdata=permute(rawdata,[1 2 3 5 6 4]);
% rawdata=reshape(rawdata,[212 32 1980*3]);
...
Kimage_first_full(:,:,3:3:end,:,:) = Kimage_first;
...
%% ACS data
data_path='/data/pnl/home/ql087/data_bwh/2023_12_22_bwh_pulseq_slr/'
filename1 = 'meas_MID00025_FID14065_pulseq_threeshot_ref'; % let's read the reference first.
D=dir([data_path filename1]);
[~,I]=sort([D(:).datenum]);
twix_obj = mapVBVD([data_path filename1]);
seq = mr.Sequence();
...
I_short=reshape(I_short, [88 88 18 4]);
% tmp=[1 3 4 6 8 9 11 13 14];
tmp=[1 3 4 ];

I_short=I_short(:,:,:,tmp);

save_path='/data/pnl/home/ql087/data_processing/2023_12_22_pulseq/slr_phantom/';
save([save_path 'se_te3.mat'], 'I_short', '-v7.3')
