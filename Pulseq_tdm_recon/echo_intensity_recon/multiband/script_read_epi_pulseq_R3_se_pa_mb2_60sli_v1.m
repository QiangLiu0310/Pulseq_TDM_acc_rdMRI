...
filename1 = 'meas_MID00632_FID04619_pulseq_mb2_se_te6_a';
filename2 = 'meas_MID00633_FID04620_pulseq_mb2_se_te6_b';
filename3 = 'meas_MID00634_FID04621_pulseq_mb2_se_te6_c';
...
%% split the pa data
rawdata=rawdata(:,:,1:size(rawdata,3)/3);
tmp=[1:220 220*2+1:220*3];
rawdata=rawdata(:,:,tmp);
clear tmp
...
dire=2;
bvalue=1;
diff_plus_dum=dire*bvalue; % dir 6 * tdm loop 3 * b-value 4
SMS=2;
...
ref=reshape(ref,[Nx Ny_sampled multiply nCoils]);
...
k_gc=reshape(k_gc,[Ny_sampled Nx multiply-multipl_dum nCoils]);
...
clear rawdata data_resampled k_gc Kimage_short
%% ACS data
% data_path='/data/pnl/home/ql087/data_bwh/2024_01_05_bwh_pulseq/'
filename1 = 'meas_MID00635_FID04622_pulseq_60sli_3_shot_ref'; % let's read the reference first.
D=dir([data_path filename1]);
[~,I]=sort([D(:).datenum]);
twix_obj = mapVBVD([data_path filename1]);
seq = mr.Sequence();
...
img_final=img;
clear img
save([save_path 'pulseq_se_te6_pa.mat'],'img_final','-v7.3')
