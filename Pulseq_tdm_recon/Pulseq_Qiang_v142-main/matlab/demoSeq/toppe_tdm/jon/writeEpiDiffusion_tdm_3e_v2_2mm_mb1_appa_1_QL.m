...
%% based on Jon's version
% ？loop: move the fundamental parameters outside of the loop
% pe_enable->scale_gyPre
% scale of the bvalue?
% May 13 2024
...
seq_name='tdm_3e_mb1_21sli_2mm_R3_1.seq';
...
for b_value=1:size(bFactor,1)
    for tdmloop=1:tdm
        ...
        for ds=1:5%dummy_count % actually it is diffusion count
