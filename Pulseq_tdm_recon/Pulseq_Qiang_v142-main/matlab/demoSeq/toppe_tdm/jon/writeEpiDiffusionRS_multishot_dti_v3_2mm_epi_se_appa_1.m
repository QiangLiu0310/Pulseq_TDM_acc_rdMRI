...
seq_file='signleecho_mb1_21sli_2mm_R3_te3.seq'; % te [1, 2, 3], group a, b
% Set system limits
B0field=3.00;% 6.98
    ...
    for ds=1:3%dummy_count
        ...
        for Nmulti=1:RSegment
            ...
            [rf180, gz180] = mr.makeSincPulse(pi,'system',lims,'Duration',tRFref,...
                'SliceThickness',thickness,'apodization',0.5,'timeBwProduct',8,'PhaseOffset',pi/2,'use','refocusing');
