% based on Pulseq se sequence for TDM echo intensity
% add a label for different dwi (TBD... not working for dti...Lipeng and Qiang)
% function trap4ge is called to generate trapezoid gradient for some of the
% gradients with very durations (Jon)
% ignore the trigger for rf excitation (Jon)
% Qiang Liu May 24

clc;close all;clear all;
seq_file='signleecho_mb1_21sli_2mm_R3_te1.seq';
% Set system limits
B0field=3.00;% 6.98
