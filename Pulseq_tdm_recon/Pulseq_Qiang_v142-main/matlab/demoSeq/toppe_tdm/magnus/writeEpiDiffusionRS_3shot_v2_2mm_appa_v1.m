...
seq_file='epidiff_3_shot_ref_2mm_21sli_2.seq';
% Set system limits
...
for ref=1:ref_count % ref 1 works as the dummy scan, and I also turn off the PE gradients to collect the reference
    ...
    for Nmulti=1:RSegment
        ...
        % add for GE QL
        gy = mr.makeTrapezoid('y',lims,'Area',-deltaky,'Duration',blip_dur,'delay',lims.adcDeadTime); % we use negative blips to save one k-space line on our way towards the k-space center
        ...
        gx = mr.makeTrapezoid('x',lims,'Area',kWidth+extra_area,'duration',readoutTime+blip_dur,'delay',lims.adcDeadTime); %QL: for GE
