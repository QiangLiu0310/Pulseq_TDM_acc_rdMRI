...
seq_file='epidiff_3_shot_ref_2mm_21sli_recon_2.seq';
% Set system limits
...
for ref=1:ref_count % ref 1 works as the dummy scan, and I also turn off the PE gradients to collect the reference
    ...
    for Nmulti=1:RSegment
        ...
        for s=1:Nslices
            ...
            % seq.addBlock(gp_r,gp_p,gp_s, mr.makeLabel('SET', 'TRID', Nmulti));
