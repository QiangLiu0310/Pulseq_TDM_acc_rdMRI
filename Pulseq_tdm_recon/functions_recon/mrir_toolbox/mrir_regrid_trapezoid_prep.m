...
% $Id: mrir_regrid_trapezoid_prep.m,v 1.2 2008/03/30 23:03:09 jonp Exp $
%**************************************************************************%
  ...
  %************************************************************************%
  %%% $Source: /space/padkeemao/1/users/jonp/cvsjrp/PROJECTS/IMAGE_RECON/mrir_toolbox/mrir_regrid_trapezoid_prep.m,v $
  %%% Local Variables:
  %%% mode: Matlab
  %%% fill-column: 76
  %%% comment-column: 0
