...
%Imagine a scatterplot between the two measures. High agreement 
%implies that the scatterplot points are close to the 45 degrees line of perfect
%concordance which runs diagonally to the scatterplot, whereas 
%a high Pearson's r implies that the scatterplot points are close to any straight line.
