...
seq_file='signleecho_mb1_18sli_2p5mm_R3_multib_te1_b.seq'; % te [1, 2, 3], group a, b
% Set system limits
B0field=2.89;% 6.98
...
for b_value=1:size(bFactor,1)
    for ds=5:5%dummy_count
        ...
        for Nmulti=1:RSegment
            ...
            %% TR calculation
            TR=2500e-3;
            delayTR=TR/Nslices*2-mr.calcDuration(gp_r) - mr.calcDuration(gn_r) - TE - rfCenterInclDelay-dur2end; % *2
