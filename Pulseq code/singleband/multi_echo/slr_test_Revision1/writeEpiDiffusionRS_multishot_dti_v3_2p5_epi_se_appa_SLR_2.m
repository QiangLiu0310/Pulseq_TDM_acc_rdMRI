...
seq_file='signleecho_mb1_10sli_2p5mm_R3_te6_slr.seq'; % te [1, 2, 3], group a, b
% Set system limits
B0field=2.89;% 6.98
    ...
    for ds=1:5%dummy_count
        ...
        for Nmulti=1:RSegment
            ...
            [rf, gz, gzReph] = mr.makeSLRpulse_LQ_v3(pi/2,'system',lims,'Duration',tRFex,...
                'SliceThickness',thickness,'timeBwProduct',4);% 'apodization',0.5,

            % Create 90 degree slice refocusing pulse and gradients
            [rf180, gz180] = mr.makeSLRpulse_LQ_v3(pi,'system',lims,'Duration',tRFref,...
                'SliceThickness',thickness,'timeBwProduct',4,'PhaseOffset',pi/2,'use','refocusing'); % 'apodization',0.5,
