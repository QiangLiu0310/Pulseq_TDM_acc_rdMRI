...
seq_file='treecho_mb1_18sli_2p5mm_R3_multib_te123_1p03.seq'; % matchtdm
% Set system limits
B0field=2.89;% 6.98
    ...
    for ds=1:5%dummy_count
        ...
        for Nmulti=1:RSegment
            ...
            [rf180, gz180] = mr.makeSincPulse(pi,'system',lims,'Duration',tRFref,...
                'SliceThickness',thickness*1.03,'apodization',0.5,'timeBwProduct',4,'PhaseOffset',pi/2,'use','refocusing');
...
%                 for s=Nslices/2+1:Nslices
                ...
                rf180.freqOffset=gz180.amplitude*thickness*1.03*interleaved_freqOffset_factor(s);
