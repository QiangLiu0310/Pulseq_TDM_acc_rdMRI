...
seq_file='treecho_mb1_18sli_2p5mm_R3_multib_tbwp6_SLR.seq'; % matchtdm
% Set system limits
B0field=2.89;% 6.98
    ...
    for ds=5:5%dummy_count
        ...
        for Nmulti=1:RSegment
            ...
            [rf, gz, gzReph] = mr.makeSLRpulse_LQ_v3(pi/2,'system',lims,'Duration',tRFex,...
                'SliceThickness',thickness,'timeBwProduct',10);% 'apodization',0.5,

            % Create 90 degree slice refocusing pulse and gradients
            [rf180, gz180] = mr.makeSLRpulse_LQ_v3(pi,'system',lims,'Duration',tRFref,...
                'SliceThickness',thickness,'timeBwProduct',10,'PhaseOffset',pi/2,'use','refocusing'); % 'apodization',0.5,
...
%% calculate the RF power
dt=2e-6;
[total_energy, peak_pwr, rf_rms]=mr.calcRfPower(rf180, dt)
