...
seq_file='dualecho_mb1_21sli_2mm_R3_1b_1dir_10ave_matchtdm_0905.seq';
% Set system limits
B0field=2.89;% 6.98
...
for b_value=1:size(bFactor,1)
    for ref=1:diffusion_count
        ...
        for Nmulti=1:RSegment
            ...
            %% TR calculation
            TR=4000e-3;
            delayTR=TR/Nslices-mr.calcDuration(rf_fs)-mr.calcDuration(gz_fs)-TE2-rfCenterInclDelay-dur2end;
