...
seq_file='signleecho_mb1_21sli_2mm_R3_1b_1dir_10ave_TE2_0905.seq';
% Set system limits
B0field=2.89;% 6.98
...
table=repmat(table,[1,10]);
table=reshape(table,[3,10])';
...
for b_value=1:size(bFactor,1)
    for ref=2:2%diffusion_count
        ...
        for Nmulti=1:RSegment
            ...
            gyPre_post = mr.makeTrapezoid('y',lims1,'Area',(Ny_post-1)*deltaky); % QL
