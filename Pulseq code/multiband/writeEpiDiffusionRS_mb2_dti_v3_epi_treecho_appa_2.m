...
seq_file='treecho_mb2_60sli_2p5mm_R3_multib_te456_c.seq'; % matchtdm
% Set system limits
B0field=2.89;% 6.98
...
for b_value=1:size(bFactor,1)
    for ds=1:dummy_count
        ...
        for Nmulti=1:RSegment
            ...
            %% TR calculation
            TR=2500e-3;
            delayTR=TR/Nslices*3-mr.calcDuration(gp_r) - mr.calcDuration(gn_r) -TE3-rfCenterInclDelay-dur2end;
